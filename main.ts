scene.onOverlapTile(SpriteKind.Enemy, sprites.swamp.swampTile13, function (sprite, location) {
    otherSprite.destroy()
...
tiles.placeOnTile(mySprite, tiles.getTileLocation(7, 4))
let nomalspeed = 70
controller.moveSprite(mySprite, nomalspeed, 0)
mysprite2()
tiles.placeOnTile(otherSprite, tiles.getTileLocation(24, 2))
